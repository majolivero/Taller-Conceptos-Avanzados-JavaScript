...
const questionnaire = (questions) => {
    try{
        ...
        alert(`Las respuestas correctas son:
            ...
            alert(`Pregunta 4: ${arrayAnswer[3]}
            Explicación: En JavaScript puedes acceder a una variable local desde un scope de bloque si la variable está definida en un scope que engloba al bloque. Sin embargo, las variables definidas dentro de un bloque solo son accesibles dentro de ese mismo bloque si se usan let o const.`)
            alert(`Pregunta 5: ${arrayAnswer[4]}
            Explicación: En JavaScript no puedes acceder a una variable de bloque desde un scope global. Las variables definidas dentro de un bloque con let o const tienen un alcance de bloque, lo que significa que solo son accesibles dentro del bloque donde fueran definidas. Fuera de ese bloque, dichas variables no existen.`)
            alert(`Pregunta 6: ${arrayAnswer[5]}
            Explicación: En JavaScript puedes acceder a una variable de bloque desde un scope local siempre que la variable de bloque esté dentro del mismo scope local o un scope que englobe al scope local.
